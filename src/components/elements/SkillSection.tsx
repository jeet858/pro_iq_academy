    ...
    <section className="flex w-[80%] flex-col justify-center self-center">
      <div className="container relative top-[] flex h-full w-full min-w-full items-center justify-center self-center">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex h-[280px] w-[280px] flex-col items-center rounded-[27px] bg-[#037ef3] p-10 shadow-lg">
            <FaCogs className=" mb-[1.5rem] text-6xl text-white" />
            <h2 className="text-center text-2xl font-semibold text-white">
              Mental Math and Advanced Skill Development
            </h2>
          </div>

          <div className="flex h-[280px] w-[280px] flex-col items-center rounded-[27px] bg-[#ffc949] p-10 shadow-lg">
            <svg
              width="62"
              height="67"
              viewBox="0 0 62 67"
              ...
              className=" mb-[1.5rem] text-2xl text-white"
            >
              <path
          ...
          <div className="flex h-[280px] w-[280px] flex-col items-center rounded-[27px] bg-[#ff4f81] p-10 shadow-lg">
            <svg
              width="81"
              height="73"
              viewBox="0 0 81 73"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className=" mb-[1.5rem] text-4xl text-white"
            >
              <path
          ...
          <div className="flex h-[280px] w-[280px] flex-col items-center rounded-[27px]  bg-[#1ee697] p-10 shadow-lg">
            <svg
              width="58"
              height="71"
              viewBox="0 0 58 71"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className=" mb-[1.5rem] text-6xl text-white"
            >
              <path
