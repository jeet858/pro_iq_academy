      ...
      <div className="mt-16">
        ...
        <div className="flex sm:flex-col sm:p-4 md:gap-12  md:p-8 lg:flex-row lg:gap-28 lg:p-16">
          <div className="relative flex items-center sm:h-[320px] sm:w-[514px] md:h-[552px] md:w-full md:justify-center lg:w-[814px]">
            <div
              className="animate-box absolute bg-[#FF4F8185] sm:-left-[50px] sm:bottom-[0px] sm:h-32 sm:w-32 md:bottom-[25px] md:left-[50px] md:h-48 md:w-48 lg:bottom-0 lg:left-0 lg:h-56 lg:w-56"
              style={{
                animation:
            ...
            ></div>
            <div
              className="animate-box absolute bg-[#FF6E65F7] sm:right-[145px] sm:top-[0px] sm:h-32 sm:w-32 md:right-[70px] md:top-[20px] md:h-48 md:w-48 lg:-right-[90px] lg:top-0 lg:h-56 lg:w-56"
              style={{
                animation:
            ...
            <Image
              src={img3}
              alt=""
              className=" relative z-0 sm:h-fit sm:w-[314px] md:h-[372px] md:w-[454px] lg:ml-16"
            />
          </div>
